...
- Отправление заказа в ресторан
  <br>
- Регистрация и авторизация (авторизация осуществляется по номеру телефона(логин) и пароль)
  <br>
...
### Kithcen-service ###
- Регистрация и авторизация (авторизация осуществляется по названию ресторана (логин) и пароль)
